...
byte por byte, ao arquivo que ja estava salvo (esse arquivo foi gerado
rodando montar.py com a base certificada da Secretaria - ver "Migracao pra
base certificada" no README do pacote). Esse teste garante que o script
montar.py continua gerando exatamente a mesma base de dados que os
experimentos usam.
...
def montar_tabela_pelo_pacote():
    return montagem_tabela.montar_tabela_final(
        fontes.carregar_secretaria_armadilhas(),
